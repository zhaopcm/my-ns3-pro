...
main (int argc, char *argv[])
{
    ...
    txQueue->SetAttribute ("MaxSize", QueueSizeValue (QueueSize ("60p")));

    dtq->GetAttribute ("MaxSize", limit);

    NS_LOG_INFO ("1.  txQueue limit changed: " << limit.Get () << " packets");




    txQueue->SetAttribute ("MaxSize", QueueSizeValue (QueueSize ("100p")));
    //txQueue->GetAttribute ("MaxSize", limit);
    dtq->GetAttribute ("MaxSize", limit);
    //txQueue->GetAttribute ("MaxSize", limit);
    NS_LOG_INFO ("2.  txQueue limit changed: " << limit.Get () << " packets");
