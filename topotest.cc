...
main (int argc, char *argv[])
{
    ...
    //LogComponentEnable ("DropTailQueue", level);
    ...
    Config::SetDefault ("ns3::OnOffApplication::PacketSize", UintegerValue (16384));
    ...
    csma.SetChannelAttribute ("Delay", StringValue ("0.02ms"));
    ...
    onoff.SetAttribute ("PacketSize", UintegerValue (16380));
